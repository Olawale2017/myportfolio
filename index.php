...
<section class="hero">
    <div class="hero-content">
        ...
        <div class="hero-actions">
            <a class="btn btn-gold" href="booking.php">Book a Consultation</a>
            <a class="btn btn-outline" href="portfolio.php">View My Work</a>
        </div>
    </div>
...
<section class="section dark-section">
    ...
    <a class="btn btn-gold" href="portfolio.php">Explore Projects</a>
</section>
...
<section class="section cta-band">
    ...
    <a class="btn btn-dark" href="booking.php">Book a Consultation</a>
</section>
